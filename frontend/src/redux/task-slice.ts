...
export const toggleCompleted = createAsyncThunk('tasks/toggleCompleted', async (toggleArgs: ToggleArgs, thunkAPI) => {
...
const taskSlice = createSlice({
	...
	extraReducers: (builder) =>
		...
		builder
			...
			.addCase(getTasks.fulfilled, (state: TaskState, action: PayloadAction<Task[]>) => {
				state.loading = false;
				state.tasks = action.payload;
			})
			...
			.addCase(toggleCompleted.fulfilled, (state: TaskState, action: PayloadAction<ToggleArgsFulfilled>) => {
