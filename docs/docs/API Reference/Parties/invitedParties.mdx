...
## Errors
- `404`, in the case the there are no parties the user is invited to. This would look like `{code: 404, error_msg: 'You have no invited parties at the moment'}`.
...
axios.get('/api/parties/invited-parties', IDtoFind).then(res => {
